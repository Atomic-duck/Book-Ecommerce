...
(1, '81dc9bdb52d04dc20036dbd8313ed055', 1, 'admin@gmail.com'),
(2, '81dc9bdb52d04dc20036dbd8313ed055', 1, 'thanhngo@gmail.com'),
(3, '81dc9bdb52d04dc20036dbd8313ed055', 2, 'admin2@gmail.com');
-- --------------------------------------------------------
...
INSERT INTO `category` (`id`, `name`, `display`) VALUES
(1, 'Khoa Học Kỹ Thuật', 1),
(2, 'Kinh Tế', 1),
(3, 'Manga - Comic', 1),
(4, 'Tâm Lý - Kỹ Năng Sống', 1),
(5, 'Văn Học', 1);
...
INSERT INTO `link_info` (`id`, `email`, `twitter`, `fb`, `pinterest`, `phone`) VALUES
(1, 'bookstore.bku@gmail.com', 'https://twitter.com/', 'https://www.facebook.com/thanhngo00', 'https://pinerest.com/', '0328386625');
...
ALTER TABLE `book`
  ...
  ADD CONSTRAINT `book_ibfk_2` FOREIGN KEY (`category`) REFERENCES `category` (`name`);
