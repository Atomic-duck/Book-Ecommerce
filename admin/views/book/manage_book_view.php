...
$bcates = $bookObj->getAllBookCategory();
    ...
    <tbody>
        ...
        foreach ($books as $book) { ?>
            <tr>
                ...
                <td> 
                    <?php 
                    foreach($bcates as $bcate){
                        if($bcate['book_id'] == $book['id']){
                            echo $bcate['category'];
                        }
                    }
                    ?>
                </td>
                <td> <a href="edit_product.php?prostatus=edit&&id=<?php echo $book['id'] ?>">Edit</a> <br>
